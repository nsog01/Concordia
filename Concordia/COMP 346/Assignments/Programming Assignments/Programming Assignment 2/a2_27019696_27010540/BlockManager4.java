...
public class BlockManager
{
	 ...
	 * Counting semaphore for Task 4, it will start at -9 and decrement by 1 every time the phase 1 goes then
	 * once the semaphore gets to 1 it'll allow the phase 2 (which are waiting on the semaphore)
	 */
