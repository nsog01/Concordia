...
public class ImageResizeService {
	...
	public BufferedImage resize(ImageResizeRequest request) throws Exception {
		...
		String imgResizeException1="No value set for image targetWidth";
		if (request.getTargetWidth() == null) {
			
			throw new Exception(imgResizeException1);
	...
	private BufferedImage getSource(ImageResizeRequest request)
		...
		if (request.getSourceFile() != null
			...
			if (!sourceFile.canRead()) {
				String imgResizeException2="Cannot read source image file from provided path.";
				throw new Exception(imgResizeException2);
			}
		}

		if (sourceFile == null) {
			String imgResizeException3="Unable to get a source image file from any of the provided information.";
			throw new Exception(
					imgResizeException3);
		}
