...
import presentation.views.files.ClientPersonalInfoPanel;

public class ClientPersonalInfoPanelController {
	
	private ClientPersonalInfoPanel view;
	private Client client;
	private FileManager fileManager;
	
	public ClientPersonalInfoPanelController(Client client)
	{
		fileManager = FileManager.getUniqueInstance();
		view = new ClientPersonalInfoPanel();
	...
	public ClientPersonalInfoPanelController(){
		view = new ClientPersonalInfoPanel();
		addListeners(medicareAction());
	}
	...
	public ClientPersonalInfoPanel getView() {
		return view;
	}
}
